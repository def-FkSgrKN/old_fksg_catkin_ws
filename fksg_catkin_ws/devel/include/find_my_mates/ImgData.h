// Generated by gencpp from file find_my_mates/ImgData.msg
// DO NOT EDIT!


#ifndef FIND_MY_MATES_MESSAGE_IMGDATA_H
#define FIND_MY_MATES_MESSAGE_IMGDATA_H
...
struct ImgData_
{
  ...
  typedef boost::shared_ptr< ::find_my_mates::ImgData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::find_my_mates::ImgData_<ContainerAllocator> const> ConstPtr;

}; // struct ImgData_

typedef ::find_my_mates::ImgData_<std::allocator<void> > ImgData;

typedef boost::shared_ptr< ::find_my_mates::ImgData > ImgDataPtr;
typedef boost::shared_ptr< ::find_my_mates::ImgData const> ImgDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::find_my_mates::ImgData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::find_my_mates::ImgData_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::find_my_mates::ImgData_<ContainerAllocator1> & lhs, const ::find_my_mates::ImgData_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::find_my_mates::ImgData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::find_my_mates::ImgData_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::find_my_mates::ImgData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::find_my_mates::ImgData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::find_my_mates::ImgData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::find_my_mates::ImgData_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::find_my_mates::ImgData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::find_my_mates::ImgData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb89fe16ae11edf80ULL;
  static const uint64_t static_value2 = 0x41200798af18005bULL;
};

template<class ContainerAllocator>
struct DataType< ::find_my_mates::ImgData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::find_my_mates::ImgData_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::find_my_mates::ImgData_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::find_my_mates::ImgData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::find_my_mates::ImgData_<ContainerAllocator>& v)
  {
    s << indent << "age_push: ";
...
#endif // FIND_MY_MATES_MESSAGE_IMGDATA_H
