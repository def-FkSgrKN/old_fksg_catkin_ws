...
(cl:defmethod cl:initialize-instance :after ((m <MoveArm-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveArm-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-srv:<MoveArm-request> is deprecated: use detect_suspicious_person-srv:MoveArm-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:x-val is deprecated.  Use detect_suspicious_person-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:y-val is deprecated.  Use detect_suspicious_person-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'deg-val :lambda-list '(m))
(cl:defmethod deg-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:deg-val is deprecated.  Use detect_suspicious_person-srv:deg instead.")
  (deg m))

(cl:ensure-generic-function 'grip-val :lambda-list '(m))
(cl:defmethod grip-val ((m <MoveArm-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:grip-val is deprecated.  Use detect_suspicious_person-srv:grip instead.")
  (grip m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveArm-request>)))
  ...
  "detect_suspicious_person/MoveArmRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveArm-request)))
  "Returns string type for a service object of type 'MoveArm-request"
  "detect_suspicious_person/MoveArmRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MoveArm-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveArm-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-srv:<MoveArm-response> is deprecated: use detect_suspicious_person-srv:MoveArm-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveArm-response>)))
  ...
  "detect_suspicious_person/MoveArmResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveArm-response)))
  "Returns string type for a service object of type 'MoveArm-response"
  "detect_suspicious_person/MoveArmResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveArm)))
  ...
  "detect_suspicious_person/MoveArm")