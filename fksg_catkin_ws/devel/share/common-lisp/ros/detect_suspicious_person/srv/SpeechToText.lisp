...
(cl:defmethod cl:initialize-instance :after ((m <SpeechToText-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SpeechToText-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-srv:<SpeechToText-request> is deprecated: use detect_suspicious_person-srv:SpeechToText-request instead.")))

(cl:ensure-generic-function 'print_partial-val :lambda-list '(m))
(cl:defmethod print_partial-val ((m <SpeechToText-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:print_partial-val is deprecated.  Use detect_suspicious_person-srv:print_partial instead.")
  (print_partial m))

(cl:ensure-generic-function 'use_break-val :lambda-list '(m))
(cl:defmethod use_break-val ((m <SpeechToText-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:use_break-val is deprecated.  Use detect_suspicious_person-srv:use_break instead.")
  (use_break m))
...
(cl:defmethod return_extract_person_name-val ((m <SpeechToText-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:return_extract_person_name-val is deprecated.  Use detect_suspicious_person-srv:return_extract_person_name instead.")
...
(cl:defmethod remove_space-val ((m <SpeechToText-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:remove_space-val is deprecated.  Use detect_suspicious_person-srv:remove_space instead.")
  (remove_space m))

(cl:ensure-generic-function 'voskLogLevel-val :lambda-list '(m))
(cl:defmethod voskLogLevel-val ((m <SpeechToText-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:voskLogLevel-val is deprecated.  Use detect_suspicious_person-srv:voskLogLevel instead.")
  (voskLogLevel m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SpeechToText-request>)))
  ...
  "detect_suspicious_person/SpeechToTextRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SpeechToText-request)))
  "Returns string type for a service object of type 'SpeechToText-request"
  "detect_suspicious_person/SpeechToTextRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SpeechToText-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SpeechToText-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-srv:<SpeechToText-response> is deprecated: use detect_suspicious_person-srv:SpeechToText-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SpeechToText-response>)))
  ...
  "detect_suspicious_person/SpeechToTextResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SpeechToText-response)))
  "Returns string type for a service object of type 'SpeechToText-response"
  "detect_suspicious_person/SpeechToTextResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SpeechToText)))
  ...
  "detect_suspicious_person/SpeechToText")