...
(cl:defmethod cl:initialize-instance :after ((m <isMeaning-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'isMeaning-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-srv:<isMeaning-request> is deprecated: use detect_suspicious_person-srv:isMeaning-request instead.")))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <isMeaning-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:text-val is deprecated.  Use detect_suspicious_person-srv:text instead.")
  (text m))

(cl:ensure-generic-function 'word_list-val :lambda-list '(m))
(cl:defmethod word_list-val ((m <isMeaning-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-srv:word_list-val is deprecated.  Use detect_suspicious_person-srv:word_list instead.")
  (word_list m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<isMeaning-request>)))
  ...
  "detect_suspicious_person/isMeaningRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'isMeaning-request)))
  "Returns string type for a service object of type 'isMeaning-request"
  "detect_suspicious_person/isMeaningRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <isMeaning-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'isMeaning-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-srv:<isMeaning-response> is deprecated: use detect_suspicious_person-srv:isMeaning-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<isMeaning-response>)))
  ...
  "detect_suspicious_person/isMeaningResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'isMeaning-response)))
  "Returns string type for a service object of type 'isMeaning-response"
  "detect_suspicious_person/isMeaningResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'isMeaning)))
  ...
  "detect_suspicious_person/isMeaning")