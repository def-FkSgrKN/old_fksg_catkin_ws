...
(cl:defmethod cl:initialize-instance :after ((m <LidarData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LidarData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-msg:<LidarData> is deprecated: use detect_suspicious_person-msg:LidarData instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <LidarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:distance-val is deprecated.  Use detect_suspicious_person-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'front_back-val :lambda-list '(m))
(cl:defmethod front_back-val ((m <LidarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:front_back-val is deprecated.  Use detect_suspicious_person-msg:front_back instead.")
  (front_back m))

(cl:ensure-generic-function 'left_right-val :lambda-list '(m))
(cl:defmethod left_right-val ((m <LidarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:left_right-val is deprecated.  Use detect_suspicious_person-msg:left_right instead.")
  (left_right m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LidarData>)))
  ...
  "detect_suspicious_person/LidarData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LidarData)))
  "Returns string type for a message object of type 'LidarData"
  "detect_suspicious_person/LidarData")
