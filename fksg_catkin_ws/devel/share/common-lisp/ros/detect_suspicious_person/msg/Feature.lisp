...
(cl:defmethod cl:initialize-instance :after ((m <Feature>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Feature)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-msg:<Feature> is deprecated: use detect_suspicious_person-msg:Feature instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Feature>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:name-val is deprecated.  Use detect_suspicious_person-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Feature>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:age-val is deprecated.  Use detect_suspicious_person-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'gender-val :lambda-list '(m))
(cl:defmethod gender-val ((m <Feature>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:gender-val is deprecated.  Use detect_suspicious_person-msg:gender instead.")
  (gender m))

(cl:ensure-generic-function 'cloth_color-val :lambda-list '(m))
(cl:defmethod cloth_color-val ((m <Feature>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:cloth_color-val is deprecated.  Use detect_suspicious_person-msg:cloth_color instead.")
  (cloth_color m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Feature>)))
  ...
  "detect_suspicious_person/Feature")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Feature)))
  "Returns string type for a message object of type 'Feature"
  "detect_suspicious_person/Feature")
