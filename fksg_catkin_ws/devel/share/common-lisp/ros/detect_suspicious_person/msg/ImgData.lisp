...
(cl:defmethod cl:initialize-instance :after ((m <ImgData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImgData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name detect_suspicious_person-msg:<ImgData> is deprecated: use detect_suspicious_person-msg:ImgData instead.")))

(cl:ensure-generic-function 'age_push-val :lambda-list '(m))
(cl:defmethod age_push-val ((m <ImgData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:age_push-val is deprecated.  Use detect_suspicious_person-msg:age_push instead.")
  (age_push m))

(cl:ensure-generic-function 'sex_push-val :lambda-list '(m))
(cl:defmethod sex_push-val ((m <ImgData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:sex_push-val is deprecated.  Use detect_suspicious_person-msg:sex_push instead.")
  (sex_push m))

(cl:ensure-generic-function 'up_color_push-val :lambda-list '(m))
(cl:defmethod up_color_push-val ((m <ImgData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:up_color_push-val is deprecated.  Use detect_suspicious_person-msg:up_color_push instead.")
  (up_color_push m))

(cl:ensure-generic-function 'down_color_push-val :lambda-list '(m))
(cl:defmethod down_color_push-val ((m <ImgData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:down_color_push-val is deprecated.  Use detect_suspicious_person-msg:down_color_push instead.")
  (down_color_push m))

(cl:ensure-generic-function 'glasstf_push-val :lambda-list '(m))
(cl:defmethod glasstf_push-val ((m <ImgData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_suspicious_person-msg:glasstf_push-val is deprecated.  Use detect_suspicious_person-msg:glasstf_push instead.")
  (glasstf_push m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ImgData>)))
  ...
  "detect_suspicious_person/ImgData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ImgData)))
  "Returns string type for a message object of type 'ImgData"
  "detect_suspicious_person/ImgData")
