...
(cl:defmethod cl:initialize-instance :after ((m <ArmAction>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmAction)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carry_my_luggage-msg:<ArmAction> is deprecated: use carry_my_luggage-msg:ArmAction instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <ArmAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carry_my_luggage-msg:joint-val is deprecated.  Use carry_my_luggage-msg:joint instead.")
  (joint m))

(cl:ensure-generic-function 'gripper-val :lambda-list '(m))
(cl:defmethod gripper-val ((m <ArmAction>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carry_my_luggage-msg:gripper-val is deprecated.  Use carry_my_luggage-msg:gripper instead.")
  (gripper m))
