...
(cl:defmethod cl:initialize-instance :after ((m <Camera_msg-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Camera_msg-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name find_my_mates-srv:<Camera_msg-request> is deprecated: use find_my_mates-srv:Camera_msg-request instead.")))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <Camera_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_my_mates-srv:w-val is deprecated.  Use find_my_mates-srv:w instead.")
  (w m))

(cl:ensure-generic-function 'n-val :lambda-list '(m))
(cl:defmethod n-val ((m <Camera_msg-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_my_mates-srv:n-val is deprecated.  Use find_my_mates-srv:n instead.")
  (n m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Camera_msg-request>)))
  ...
  "find_my_mates/Camera_msgRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Camera_msg-request)))
  "Returns string type for a service object of type 'Camera_msg-request"
  "find_my_mates/Camera_msgRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Camera_msg-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Camera_msg-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name find_my_mates-srv:<Camera_msg-response> is deprecated: use find_my_mates-srv:Camera_msg-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Camera_msg-response>)))
  ...
  "find_my_mates/Camera_msgResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Camera_msg-response)))
  "Returns string type for a service object of type 'Camera_msg-response"
  "find_my_mates/Camera_msgResponse")
