...
(cl:defmethod cl:initialize-instance :after ((m <RealTime>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RealTime)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name find_my_mates-msg:<RealTime> is deprecated: use find_my_mates-msg:RealTime instead.")))

(cl:ensure-generic-function 'robo_p_dis-val :lambda-list '(m))
(cl:defmethod robo_p_dis-val ((m <RealTime>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_my_mates-msg:robo_p_dis-val is deprecated.  Use find_my_mates-msg:robo_p_dis instead.")
  (robo_p_dis m))

(cl:ensure-generic-function 'robo_p_drct-val :lambda-list '(m))
(cl:defmethod robo_p_drct-val ((m <RealTime>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader find_my_mates-msg:robo_p_drct-val is deprecated.  Use find_my_mates-msg:robo_p_drct instead.")
  (robo_p_drct m))
